...
export function isGenericContinuationLine(line) {
    return CONTINUATION_RE.test(line);
}
/** A line "starts a new entry" under the generic heuristic iff it is not a continuation. */
export const GENERIC_ENTRY_START = /^(?!\s|at |#\d+|Traceback|Caused by|Stack trace:).*/;
//# sourceMappingURL=continuation-heuristic.js.map