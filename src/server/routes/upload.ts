 ...
 */
export function registerUploadRoute(fastify: FastifyInstance, state: AppState): void {
  fastify.post("/api/upload", async (request, reply) => {
    const rawName = (request.query as Record<string, unknown>).name;
    ...
    const bodyStream = request.body as unknown as Readable;
...
function closeConnectionOnceFlushed(request: FastifyRequest, reply: FastifyReply): void {
