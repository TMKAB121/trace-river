...
| B4 | Phase 4 — Error Intelligence: error fingerprinting & grouping, sidebar badges, errors panel, errors-only toggle, jump-to-latest-error, spike detection, AI prompt generation with redaction + preview modal. See docs/phases/phase-4-error-intelligence.md. | high | done | 004 |
